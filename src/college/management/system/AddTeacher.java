...
class AddTeacher implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id4,id5,id6,id7,id8,id10,id11,id12,id15,id16,id17,lab,lab1,lab2;
    JTextField t1,t2,t4,t5,t6,t7,t10,t11;
    JButton b,b1,b2,b3;
    JComboBox c1,c2;
  ...
  public AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("college/management/system/icons/bg.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into teacher values('"+a+"','"+bb+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+j+"','"+k+"','"+l+"','"+m+"')";
