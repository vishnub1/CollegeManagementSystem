...
class UpdateTeacher implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id4,id5,id6,id7,id8,id11,id12,id15,lab,lab1,lab2;
    JTextField t,t1,t2,t4,t5,t6,t7,t10,t11,t12,t13,t14;
    JButton b,b1,b2; 
    String id_emp;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set name='"+t1.getText()+"',sir_name='"+t2.getText()+"',dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',aadhar='"+t10.getText()+"', emp_id = '"+t11.getText()+"',course='"+t13.getText()+"',dept='"+t14.getText()+"' where emp_id='"+t12.getText()+"'";
