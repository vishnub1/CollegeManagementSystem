...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - College Management System");
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("college/management/system/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : Vishnukant & Harshavardhan");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l8 = new JLabel("Contact    : college@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Education : MCA(Master of Computer Application)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone - 7878999900");
